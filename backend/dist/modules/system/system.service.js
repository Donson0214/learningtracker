...
exports.getSystemAnalytics = exports.setOrganizationActive = exports.listCoursesPaged = exports.listMembersPaged = exports.listOrganizationCoursesPaged = exports.listOrganizationMembersPaged = exports.listOrganizationsPaged = exports.getOrganizationSummaryById = void 0;
...
const getOrganizationSummaryById = async (organizationId) => {
...
exports.getOrganizationSummaryById = getOrganizationSummaryById;
const listOrganizationsPaged = async (options) => {
...
exports.listOrganizationsPaged = listOrganizationsPaged;
const listOrganizationMembersPaged = async (organizationId, options) => {
    const [items, total] = await Promise.all([
...
exports.listOrganizationMembersPaged = listOrganizationMembersPaged;
const listOrganizationCoursesPaged = async (organizationId, options) => {
...
exports.listOrganizationCoursesPaged = listOrganizationCoursesPaged;
const listMembersPaged = async (options) => {
    const [items, total] = await Promise.all([
        prisma_1.prisma.user.findMany({
            orderBy: { createdAt: "desc" },
            skip: options.skip,
...
const listCoursesPaged = async (options) => {
    if (options.includeModules) {
        const [items, total] = await Promise.all([
            prisma_1.prisma.course.findMany({
                orderBy: { createdAt: "desc" },
...
exports.listCoursesPaged = listCoursesPaged;
...
exports.setOrganizationActive = setOrganizationActive;
const getSystemAnalytics = async () => {
    const [organizations, totalLearners, totalCourses, sessionAggregate] = await Promise.all([
        prisma_1.prisma.organization.findMany({
            select: {
                id: true,
                name: true,
        ...
        prisma_1.prisma.user.count({ where: { role: "LEARNER" } }),
        prisma_1.prisma.course.count(),
    ...
    const sessions = await prisma_1.prisma.studySession.findMany({
