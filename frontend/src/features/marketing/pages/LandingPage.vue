...
const heroVideoUrl =
  "https://assets.mixkit.co/videos/preview/mixkit-typing-on-a-laptop-with-study-notes-28301-large.mp4";
const heroPosterUrl =
...
<template>
  <div
    class="landing min-h-screen bg-slate-50 text-slate-900 dark:bg-slate-950 dark:text-white
  ...
  >
    <div class="relative overflow-hidden">
      ...
      <div class="relative z-10">
        <div class="hidden md:flex items-center justify-between px-5 sm:px-6 py-3 text-xs text-white/70">
        ...
        <header
          class="sticky top-0 z-20 flex items-center justify-between gap-3 px-5 sm:px-6 py-4
                 pt-[env(safe-area-inset-top)] backdrop-blur-xl bg-slate-950/40 border-b border-white/10"
        >
          <div class="flex items-center gap-3 min-w-0">
            ...
            <div>
              <p class="text-sm sm:text-base font-semibold tracking-wide text-white">Trackademy</p>
              <p class="hidden sm:block text-[11px] uppercase tracking-[0.2em] text-white/60">Learning OS</p>
            </div>
          </div>
          ...
          <div class="flex items-center gap-3">
            <button
              type="button"
              class="inline-flex h-9 w-9 items-center justify-center rounded-full border border-white/20 text-white/80
            ...
            <button
              type="button"
              class="inline-flex items-center gap-2 rounded-full bg-white/90 text-slate-950 px-4 py-2 text-xs font-semibold
                     hover:-translate-y-0.5 transition"
              @click="openAuth('register')"
            >
              <span class="hidden sm:inline">Apply Today</span>
        ...
        <div class="lg:hidden px-5 sm:px-6 pb-4">
          <div class="flex items-center gap-2 overflow-x-auto pb-1 text-xs text-white/70">
            <button
              v-for="item in navItems"
              :key="item.id"
              type="button"
              class="whitespace-nowrap rounded-full border border-white/20 px-3 py-1 transition hover:text-white hover:border-white/40"
        ...
        <section id="home" class="section-anchor relative px-5 sm:px-6 pb-14 sm:pb-16 pt-12 lg:pt-20">
          <div class="mx-auto grid max-w-6xl gap-10 lg:gap-12 lg:grid-cols-[1.1fr_0.9fr]">
            <div class="space-y-6 text-white">
              ...
              <div class="flex flex-col gap-3 sm:flex-row sm:items-center">
                <button
                  type="button"
                  class="w-full sm:w-auto rounded-full bg-white/90 px-5 py-3 text-sm font-semibold text-slate-950 hover:-translate-y-0.5 transition"
                  @click="openAuth('register')"
                >
                  Apply Today
                </button>
                <button
                  type="button"
                  class="inline-flex w-full sm:w-auto items-center justify-center gap-2 rounded-full border border-white/30 px-5 py-3 text-sm text-white
            ...
            <div class="relative">
              <div class="rounded-[32px] border border-white/10 bg-white/10 p-3 shadow-[0_30px_80px_rgba(0,0,0,0.45)]">
                <div class="overflow-hidden rounded-[28px] bg-white/10 p-3">
                  ...
                  class="h-64 w-full rounded-[20px] object-cover sm:h-72"
                />
              </div>
          ...
          <div class="mx-auto mt-8 sm:mt-10 grid max-w-6xl gap-6 rounded-3xl border border-white/10 bg-white/10 p-5 sm:p-6 text-white/80 md:grid-cols-3">
            <div
    ...
    <main class="relative z-10">
      <section id="organizations" class="section-anchor px-5 sm:px-6 py-12 sm:py-16" data-reveal>
        <div class="mx-auto max-w-6xl">
          <div class="mb-10 flex items-center justify-between">
            <div>
              <p class="text-xs uppercase tracking-[0.3em] text-slate-600 dark:text-slate-300">
                Organizations
              </p>
            ...
            <button
              ...
              class="hidden md:inline-flex items-center gap-2 rounded-full border border-slate-200 px-4 py-2 text-xs text-slate-600
                     hover:text-slate-900 hover:border-slate-400 dark:border-white/20 dark:text-slate-300 dark:hover:text-white"
              @click="openAuth('register')"
            >
              Get Started
              <ArrowRightIcon class="h-4 w-4" />
      ...
      <section ref="statsRef" class="px-5 sm:px-6 pb-12 sm:pb-16" data-reveal>
        <div class="mx-auto max-w-6xl rounded-[32px] border border-slate-200 bg-white p-6 sm:p-8 dark:border-white/10 dark:bg-slate-900">
      ...
      <section id="about" class="section-anchor px-5 sm:px-6 py-12 sm:py-16" data-reveal>
        <div class="mx-auto grid max-w-6xl gap-10 lg:grid-cols-[0.95fr_1.05fr]">
          <div class="space-y-6">
            ...
            <div class="flex flex-wrap gap-3">
              ...
              <button
                type="button"
                class="rounded-full border border-slate-200 px-5 py-3 text-sm text-slate-600 hover:text-slate-900 transition
                       dark:border-white/20 dark:text-slate-300 dark:hover:text-white"
                @click="openAuth('login')"
              >
                Meet the team
              </button>
          ...
          <div class="relative">
            ...
            <div class="absolute -bottom-6 left-6 hidden lg:block">
              <div class="rounded-2xl bg-white px-4 py-3 shadow-xl dark:bg-slate-900">
                <p class="text-xs text-slate-600 dark:text-slate-300">Ranked #1 in learner outcomes</p>
      ...
      <section id="courses" class="section-anchor px-5 sm:px-6 py-12 sm:py-16" data-reveal>
        <div class="mx-auto max-w-6xl">
          <div class="mb-10 flex items-center justify-between">
            <div>
              <p class="text-xs uppercase tracking-[0.3em] text-slate-600 dark:text-slate-300">
          ...
          <div class="grid gap-6 md:grid-cols-3">
            <button
              ...
              @click="openAuth('register')"
            >
              <p class="text-xs uppercase tracking-[0.2em] text-slate-600 dark:text-slate-300">
                {{ course.level }}
              </p>
              <h3 class="mt-3 text-lg font-semibold text-slate-900 dark:text-white">
                {{ course.title }}
              </h3>
              <div class="mt-4 flex items-center justify-between text-xs text-slate-600 dark:text-slate-300">
      ...
      <section class="px-5 sm:px-6 py-12 sm:py-16" data-reveal>
        <div class="mx-auto max-w-6xl">
          <div class="mb-10 flex items-center justify-between">
            <div>
              <p class="text-xs uppercase tracking-[0.3em] text-slate-600 dark:text-slate-300">
      ...
      <section class="px-5 sm:px-6 pb-16 sm:pb-20 pt-8 sm:pt-10" data-reveal>
        <div class="mx-auto max-w-6xl rounded-[36px] bg-slate-900 px-6 sm:px-8 py-10 sm:py-12 text-white dark:bg-white dark:text-slate-900">
    ...
    <footer
      id="contact"
      class="section-anchor border-t border-slate-200 px-5 sm:px-6 py-8 sm:py-10 text-sm text-slate-600 dark:border-white/10 dark:text-slate-300"
    >
